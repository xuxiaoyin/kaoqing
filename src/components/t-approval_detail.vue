<template>
	<div id="content-right">
		<div class="right-title">
			广州航海学院学生考勤系统--审批信息
			<router-link to="/index/approval_list">审批列表</router-link>
		</div>
		...
		<div class="myself-info">
			...
			<div class="delect">
				<!-- <button>删除</button> -->
				<button type="button" @click="adopt(1)">通过</button>
				<button type="button" @click="adopt(2)" class="refuse">不通过</button>
			</div>
		</div>
	...
	export default {
		...
		methods:{
			getinfo(){
				...
				this.$axios.get('http://gzhh.gzziyu.com/index.php/home/leave_tea_api/info'+CESHI,{
					 params: {
